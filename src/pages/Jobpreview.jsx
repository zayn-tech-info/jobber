      ...
      <div className="p-5">
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 w-40 py-2 px-5 py-2 bg-[#FFBF46] rounded-md justify-center">
              <span className="">Designer</span>
              <ion-icon className="text-2xl" name="close-outline"></ion-icon>
            </div>
            <div className="flex items-center gap-2 w-40 py-2 justify-center border-dotted border-1 border-[#FFBF46]">
        ...
        <div className="flex justify-center gap-15 mt-10">
            ...
            <button className="bg-[#fbbf24] text-xl font-medium px-9 rounded-md py-3">Ok</button>
        </div>
      </div>
    </div>
  );
